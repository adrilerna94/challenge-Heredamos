...
export default function StepControls({ isFirstStep = false, onNext, onPrev, onlyBack = false, isLastStep = false }) {
    return (
        <div className="flex gap-2 mt-4">
            {/* solo mostramos botón atrás cuando esté en un paso mayor al primero */}
            {!isFirstStep && (
                <Button
                    onClick = {onPrev}
